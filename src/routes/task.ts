...
import { checkIssueSecurity, requireTaskEditor } from "../middleware/permission";
...
router.post("/:taskKey/move", checkIssueSecurity, requireTaskEditor, taskController.move);
...
router.post("/:taskKey/comments", checkIssueSecurity, requireTaskEditor, commentController.create);

router.put("/:taskKey", checkIssueSecurity, requireTaskEditor, taskController.update);
router.put("/reorder", requireTaskEditor, taskController.reorder);
router.put("/:taskKey/comments/:commentId", checkIssueSecurity, requireTaskEditor, commentController.update);
...
router.delete("/:taskKey/comments/:commentId", checkIssueSecurity, requireTaskEditor, commentController.remove);
