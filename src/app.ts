...
import notificationSchemeRoutes from "./routes/notificationScheme";
...
import workflowSchemeRoutes from "./routes/workflowScheme";
...
app.use("/api/notification-schemes", notificationSchemeRoutes);
app.use("/api/notification-preferences", notificationPreferencesRoutes);
app.use("/api/tasks", watchRoutes);
app.use("/api/sprints", sprintRoutes);
app.use("/api/epics", epicRoutes);
app.use("/api/workflows", workflowRoutes);
app.use("/api/workflow-schemes", workflowSchemeRoutes);
